...
def main():
    ...
    with open(log_file, 'w') as f:
        f.write("Timestamp,Latitude,Longitude,Distance (meters),Cumulative Distance (meters)\n")
    ...
    try:
        ...
        with serial.Serial(gps_port, baud_rate, timeout=1) as serial_port:
            ...
            while True:
                ...
                data = serial_port.readline().decode('ascii', errors='ignore').strip()
                ...
                if gps_data:
                    ...
                    with open(log_file, 'a') as f:
                        f.write(f"{timestamp},{lat},{lon},{distance:.2f},{cumulative_distance:.2f}\n")
                    ...
                    print(f"Cumulative Distance: {cumulative_distance:.2f} meters\n")
