...
class Image:
    def __init__(self, img):    # "img" is the current image, "pre" is the one from previous timstamp
        self.img = img
        self.pre = img
    ...
    #Credit: https://github.com/joncooper65/raspberry-aurora/blob/master/detect.py
